...
<div class='box'>
  <div class='box-form'>
    ...
    <div class='box-login'><form action="" method="post" name="login">
      <div class='fieldset-body' id='login_form'>
		...
		<div style='float:left; width:130px; height:95px;'>
		<a href='addy.php?id=<?php echo  $home='bank';?>' onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">
      	<div style='float:left; width:120px; height:60px;margin-top:10px;'>
		...
		<div style='float:left; width:130px; height:95px;'>
		<a href='addy.php?id=<?php echo  $home='mobile';?>'onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">
      	<div style='float:left; width:120px; height:60px;margin-top:10px;'>
		...
		Verify Payment
			...
			<div style='float:left; width:130px; height:95px;'>
		<a href='download.php?id=<?php echo  $home='application';?>' onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">
      	<div style='float:left; width:120px; height:60px;margin-top:10px;'>
 ...
 <iframe src="adds.php?id=<?php echo $_GET['id'];?>" width='790' height='330' style='border:none;'></iframe> 
  </div>   
